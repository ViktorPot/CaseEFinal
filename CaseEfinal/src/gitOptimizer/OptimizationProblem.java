...
public abstract class OptimizationProblem {
    ...
    /**
     * Returns the number of variables for the problem. For example, in a
     * bivariate problem, getNumVar() would return 2.
     */
    ...
    /**
     * Provides bounds for one variable of the problem. Reasonable bounds should
     * ideally be set for every optimization problem to ensure the most
     * efficient optimization. The main use of the Constraint class is to
     * provide a means of random number generation for variable values.
     */
    ...
    /**
     * Returns true if entire solution meets both any defined variable
     * constraints as well as the custom constraints defined by concrete
     * problems.
     */
